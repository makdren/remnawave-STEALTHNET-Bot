...
export function mainMenu(opts) {
    ...
    for (const b of list) {
        ...
        if (b.id === "cabinet") {
            ...
            const w = { text: b.label, web_app: { url: `${base}/cabinet/tickets` } };
            if (iconId)
                w.icon_custom_emoji_id = iconId;
            items.push({ node: w, onePerRow });
        }
...
export function supportSubMenu(links, backLabel, backStyle, emojiIds, lang = "ru") {
...
export function backToMenu(backLabel, backStyle, emojiIds, lang = "ru") {
...
export function profileButtons(backLabel, innerStyles, emojiIds, autoRenewEnabled, lang = "ru") {
    const back = (backLabel && backLabel.trim()) || _t("back_to_menu", lang);
...
export function langButtons(langs, innerStyles, emojiIds, lang = "ru") {
...
export function currencyButtons(currencies, innerStyles, emojiIds, lang = "ru") {
...
export function trialConfirmButton(innerStyles, emojiIds, lang = "ru") {
...
export function giftMenuButtons(backLabel, innerStyles, emojiIds) {
    const tariffPay = resolveStyle(toStyle(innerStyles?.tariffPay), "success");
    const back = (backLabel && backLabel.trim()) || DEFAULT_BACK_LABEL;
    const backSty = resolveStyle(toStyle(innerStyles?.back), "danger");
    return {
...
export function giftSubscriptionButtons(subscriptions, backLabel, innerStyles, emojiIds) {
    const back = (backLabel && backLabel.trim()) || DEFAULT_BACK_LABEL;
    const backSty = resolveStyle(toStyle(innerStyles?.back), "danger");
    const rows = [];
...
export function giftPostPurchaseButtons(subscriptionId, subscriptionIndex, backLabel, innerStyles, emojiIds) {
    const back = (backLabel && backLabel.trim()) || DEFAULT_BACK_LABEL;
    const backSty = resolveStyle(toStyle(innerStyles?.back), "danger");
    return {
        inline_keyboard: [
...
export function giftCodeResultButtons(backLabel, innerStyles, emojiIds) {
    const back = (backLabel && backLabel.trim()) || DEFAULT_BACK_LABEL;
    const backSty = resolveStyle(toStyle(innerStyles?.back), "danger");
    return {
        inline_keyboard: [
...
export function giftCodesListButtons(codes, backLabel, innerStyles, emojiIds) {
    const back = (backLabel && backLabel.trim()) || DEFAULT_BACK_LABEL;
    const backSty = resolveStyle(toStyle(innerStyles?.back), "danger");
    const rows = [];
...
export function giftTariffButtons(categories, backLabel, innerStyles, emojiIds) {
    const tariffPay = resolveStyle(toStyle(innerStyles?.tariffPay), "success");
    const back = (backLabel && backLabel.trim()) || DEFAULT_BACK_LABEL;
    const backSty = resolveStyle(toStyle(innerStyles?.back), "danger");
    const tariffId = emojiIds?.tariff;
...
export function giftPaymentButtons(tariffId, balanceLabel, backLabel, innerStyles, emojiIds) {
    const back = (backLabel && backLabel.trim()) || DEFAULT_BACK_LABEL;
    const backSty = resolveStyle(toStyle(innerStyles?.back), "danger");
    const cardId = emojiIds?.card;
    return {
