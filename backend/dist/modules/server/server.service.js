...
async function readHostFile(name) {
...
async function getHostHostname() {
...
function parseSshdParam(content, param, fallback) {
...
export async function updateSshConfig(updates) {
    ...
    function setParam(src, param, value) {
