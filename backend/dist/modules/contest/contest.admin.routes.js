...
contestAdminRouter.patch("/:id", asyncRoute(async (req, res) => {
    ...
    if (data.prize1Type != null)
        update.prize1Type = data.prize1Type;
    if (data.prize1Value != null)
        update.prize1Value = data.prize1Value;
    if (data.prize2Type != null)
        update.prize2Type = data.prize2Type;
    if (data.prize2Value != null)
        update.prize2Value = data.prize2Value;
    if (data.prize3Type != null)
        update.prize3Type = data.prize3Type;
    if (data.prize3Value != null)
        update.prize3Value = data.prize3Value;
    if (data.conditionsJson !== undefined)
        update.conditionsJson = data.conditionsJson;
    if (data.drawType != null)
        update.drawType = data.drawType;
    if (data.dailyMessage !== undefined)
        update.dailyMessage = data.dailyMessage;
    if (data.buttonText !== undefined)
        update.buttonText = data.buttonText;
    if (data.buttonUrl !== undefined)
        update.buttonUrl = data.buttonUrl;
...
contestAdminRouter.patch("/:id/status", asyncRoute(async (req, res) => {
    ...
    if (!body.success)
        return res.status(400).json({ message: "Укажите status" });
...
//# sourceMappingURL=contest.admin.routes.js.map