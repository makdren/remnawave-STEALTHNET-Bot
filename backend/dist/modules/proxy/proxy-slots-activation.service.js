 ...
 */
export async function createProxySlotsByPaymentId(paymentId) {
    ...
    const created = await prisma.$transaction(slots.map((s) => prisma.proxySlot.create({
        data: {
            nodeId: s.nodeId,
            clientId: client.id,
...
//# sourceMappingURL=proxy-slots-activation.service.js.map