 ...
 */
export async function createSingboxSlotsByPaymentId(paymentId) {
    ...
    const created = await prisma.$transaction(slots.map((s) => prisma.singboxSlot.create({
        data: {
            nodeId: s.nodeId,
            clientId: client.id,
...
//# sourceMappingURL=singbox-slots-activation.service.js.map