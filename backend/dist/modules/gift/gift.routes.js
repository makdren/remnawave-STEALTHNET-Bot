...
import { z } from "zod";
import { createAdditionalSubscription, activateForSelf, deleteSubscription, listClientSubscriptions, listAllClientSubscriptions, createGiftCode, redeemGiftCode, cancelGiftCode, listGiftCodes, getSubscriptionUrl, getGiftHistory, getPublicGiftCodeInfo, } from "./gift.service.js";
 ...
 */
giftPublicRouter.get("/:code", async (req, res) => {
...
giftRouter.post("/buy", async (req, res) => {
...
giftRouter.get("/subscriptions", async (req, res) => {
    const clientId = req.clientId;
...
giftRouter.get("/subscriptions/all", async (req, res) => {
    const clientId = req.clientId;
...
giftRouter.post("/activate-self", async (req, res) => {
    const clientId = req.clientId;
...
giftRouter.delete("/subscription/:id", async (req, res) => {
    const clientId = req.clientId;
...
giftRouter.post("/create-code", async (req, res) => {
    const clientId = req.clientId;
...
giftRouter.post("/redeem", async (req, res) => {
    const clientId = req.clientId;
...
giftRouter.delete("/cancel/:codeOrId", async (req, res) => {
    const clientId = req.clientId;
...
giftRouter.get("/codes", async (req, res) => {
    const clientId = req.clientId;
...
giftRouter.get("/history", async (req, res) => {
    const clientId = req.clientId;
...
giftRouter.get("/subscription-url/:id", async (req, res) => {
    const clientId = req.clientId;
    const subscriptionId = req.params.id;
