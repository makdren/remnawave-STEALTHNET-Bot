...
const SYSTEM_CONFIG_KEYS = [
  ...
  "smtp_from_email", "smtp_from_name", "registration_email_template", "email_code_login_enabled", "public_app_url",
...
export async function getSystemConfig() {
  ...
  return {
    ...
    registrationEmailTemplate: map.registration_email_template || null,
    emailCodeLoginEnabled: map.email_code_login_enabled !== "false" && map.email_code_login_enabled !== "0",
...
export async function getPublicConfig() {
  ...
  return {
    ...
    emailCodeLoginEnabled: full.emailCodeLoginEnabled ?? true,
